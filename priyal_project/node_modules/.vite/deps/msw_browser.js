...
function shouldBypassRequest(request) {
  var _a19;
  return !!((_a19 = request.headers.get("accept")) == null ? void 0 : _a19.includes("msw/passthrough"));
}
  ...
  async resolve(handlers, onUnhandledFrame, resolutionContext) {
    ...
    const [lookupError, lookupResult] = await until(() => {
      ...
      return executeHandlers({
        ...
        handlers,
        resolutionContext: {
          baseUrl: (_a19 = resolutionContext == null ? void 0 : resolutionContext.baseUrl) == null ? void 0 : _a19.toString(),
  ...
  */
  send(data) {
    ...
    queueMicrotask(() => {
      var _a19;
      this.bufferedAmount = 0;
      (_a19 = this[kOnSend]) == null ? void 0 : _a19.call(this, data);
    });
  }
...
function getVariable(variableName) {
  ...
  return (_a19 = globalThis[variableName]) == null ? void 0 : _a19.toString();
}
...
var Interceptor2 = class {
  ...
  */
  ...
  getInstance() {
    ...
    this.logger.info("retrieved global instance:", (_a19 = instance == null ? void 0 : instance.constructor) == null ? void 0 : _a19.name);
    return instance;
  }
  setInstance() {
...
var _a4;
var WebSocketOverride2 = (_a4 = class extends EventTarget {
  constructor(url, protocols) {
    super();
    this.CONNECTING = 0;
    this.OPEN = 1;
  ...
  */
  send(data) {
    ...
    queueMicrotask(() => {
      var _a19;
      this.bufferedAmount = 0;
      (_a19 = this[kOnSend2]) == null ? void 0 : _a19.call(this, data);
    });
  }
  close(code = 1e3, reason) {
...
}, _a4.CONNECTING = 0, _a4.OPEN = 1, _a4.CLOSING = 2, _a4.CLOSED = 3, _a4);
...
var _a5;
var WebSocketInterceptor2 = (_a5 = class extends Interceptor2 {
  constructor() {
    super(_a5.symbol);
  }
  checkEnvironment() {
...
}, _a5.symbol = Symbol("websocket"), _a5);
...
var _executor2, _DeferredPromise2_instances, decorate_fn2, _a6;
var DeferredPromise22 = (_a6 = class extends Promise {
  constructor(executor = null) {
...
var _RequestController2_instances, handled_get, _a7;
var RequestController = (_a7 = class {
  constructor(request, source) {
    __privateAdd(this, _RequestController2_instances);
    this.request = request;
    this.source = source;
    this.readyState = _a7.PENDING;
  ...
  */
  async passthrough() {
    invariant2.as(InterceptorError, this.readyState === _a7.PENDING, 'Failed to passthrough the "%s %s" request: the request has already been handled', this.request.method, this.request.url);
    this.readyState = _a7.PASSTHROUGH;
  ...
  */
  respondWith(response) {
    invariant2.as(InterceptorError, this.readyState === _a7.PENDING, 'Failed to respond to the "%s %s" request with "%d %s": the request has already been handled (%d)', this.request.method, this.request.url, response.status, response.statusText || "OK", this.readyState);
    this.readyState = _a7.RESPONSE;
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  ...
  */
  errorWith(reason) {
    invariant2.as(InterceptorError, this.readyState === _a7.PENDING, 'Failed to error the "%s %s" request with "%s": the request has already been handled (%d)', this.request.method, this.request.url, reason == null ? void 0 : reason.toString(), this.readyState);
    this.readyState = _a7.ERROR;
    this.source.errorWith(reason);
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  }
}, _RequestController2_instances = new WeakSet(), handled_get = function() {
  return this.handled;
}, _a7.PENDING = 0, _a7.PASSTHROUGH = 1, _a7.RESPONSE = 2, _a7.ERROR = 3, _a7);
...
var _a8;
var FetchResponse = (_a8 = class extends Response {
  static isConfigurableStatusCode(status) {
    return status >= 200 && status <= 599;
  }
  static isRedirectResponse(status) {
    return _a8.STATUS_CODES_WITH_REDIRECT.includes(status);
  }
  /**
  ...
  */
  static isResponseWithBody(status) {
    return !_a8.STATUS_CODES_WITHOUT_BODY.includes(status);
  }
  ...
  */
  ...
  constructor(body, init = {}) {
    ...
    const safeStatus = _a8.isConfigurableStatusCode(status) ? status : 200;
    const finalBody = _a8.isResponseWithBody(status) ? body : null;
    super(finalBody, {
      status: safeStatus,
    ...
    _a8.setUrl(init.url, this);
  }
}, _a8.STATUS_CODES_WITHOUT_BODY = [
  101,
  103,
  204,
  205,
  304
], _a8.STATUS_CODES_WITH_REDIRECT = [
  301,
  302,
  303,
  307,
...
var _list, _lens, _LensList_instances, openLens_fn, _a9;
var LensList = (_a9 = class {
  constructor() {
...
var _a10, _b, _c, _d, _returnType, _e;
var TypedEvent2 = (_e = class extends (_d = MessageEvent, _c = kDefaultPrevented22, _b = kPropagationStopped, _a10 = kImmediatePropagationStopped, _d) {
  constructor(...args) {
    super(args[0], args[1]);
    /**
...
var _listeners, _listenerOptions, _typelessListeners, _hookListeners, _hookListenerOptions, _Emitter2_instances, addListener_fn, proxyEvent_fn, callListener_fn, matchListeners_fn, isTypelessListener_fn, _a11;
var Emitter22 = (_a11 = class {
  constructor() {
  ...
  */
  removeAllListeners(type) {
    ...
    if (type == null) {
      ...
      for (const [hookType, hookListener] of __privateGet(this, _hookListeners)) if (!((_a19 = __privateGet(this, _hookListenerOptions).get(hookListener)) == null ? void 0 : _a19.persist)) __privateGet(this, _hookListeners).delete(hookType, hookListener);
      return;
    }
...
var _workerEvent, _a12;
var WorkerEvent = (_a12 = class extends TypedEvent2 {
...
}, _workerEvent = new WeakMap(), _a12);
var _getWorker, _controller2, _a13;
var WorkerChannel = (_a13 = class extends Emitter22 {
  constructor(options) {
    super();
...
}, _getWorker = new WeakMap(), _controller2 = new WeakMap(), _a13);
...
var _a14, _current, _options, _frames2, _channel, _listenerController, _clientPromise, _keepAliveInterval, _stoppedAt, __ServiceWorkerSource_instances, startWorker_fn, handleRequest_fn2, handleResponse_fn2, _defaultFindWorker, checkWorkerIntegrity_fn, printStartMessage_fn, printStopMessage_fn;
var ServiceWorkerSource = (_a14 = class extends NetworkSource {
  constructor(options) {
    super();
  ...
  static async from(options) {
    if (__privateGet(_a14, _current) == null) {
      __privateSet(_a14, _current, new _a14(options));
    } else if (shouldInvalidateWorker(__privateGet(__privateGet(_a14, _current), _options), options)) {
      await __privateGet(_a14, _current).terminate();
      __privateSet(_a14, _current, new _a14(options));
    }
    return __privateGet(_a14, _current);
  }
  async enable() {
  ...
  disable() {
    ...
    (_a19 = __privateGet(this, _listenerController)) == null ? void 0 : _a19.abort();
  ...
  async terminate() {
    ...
    if (__privateGet(_a14, _current) === this) {
      __privateSet(_a14, _current, void 0);
    }
  }
  ...
  if (worker == null) {
    const missingWorkerMessage = ((_a19 = __privateGet(this, _options)) == null ? void 0 : _a19.findWorker) ? devUtils.formatMessage(
...
Please consider using a custom "serviceWorker.url" option to point to the actual worker script location, or a custom "findWorker" option to resolve the Service Worker registration manually. More details: https://mswjs.io/docs/api/setup-worker/start`,
  ...
  if ((_a19 = response.type) == null ? void 0 : _a19.includes("opaque")) {
...
}, __privateAdd(_a14, _current), _a14);
var _event, _ServiceWorkerHttpNetworkFrame_instances, respondWith_fn, _a15;
var ServiceWorkerHttpNetworkFrame = (_a15 = class extends HttpNetworkFrame {
  constructor(options) {
...
var _a16;
var FetchInterceptor = (_a16 = class extends Interceptor2 {
  constructor() {
    super(_a16.symbol);
  }
  checkEnvironment() {
      ...
      methodCall: ([methodName, args], invoke) => {
        switch (methodName) {
          ...
          case "send": {
            ...
            queueMicrotask(() => {
              var _a19;
              (((_a19 = this.onRequest) == null ? void 0 : _a19.call(this, {
                request: fetchRequest,
                requestId: this.requestId
...
var _a17;
var XMLHttpRequestInterceptor = (_a17 = class extends Interceptor2 {
  constructor() {
    super(_a17.interceptorSymbol);
  }
  checkEnvironment() {
...
}, _a17.interceptorSymbol = Symbol("xhr"), _a17);
var _FallbackHttpSource_instances, printStartMessage_fn2, printStopMessage_fn2, _a18;
var FallbackHttpSource = (_a18 = class extends InterceptorSource {
  constructor(options) {
    super({
  ...
  return {
    async start(options) {
      ...
      const httpSource = supportsServiceWorker() ? await ServiceWorkerSource.from({
        serviceWorker: {
          url: ((_b2 = (_a19 = options == null ? void 0 : options.serviceWorker) == null ? void 0 : _a19.url) == null ? void 0 : _b2.toString()) || DEFAULT_WORKER_URL,
